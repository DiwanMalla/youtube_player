      ...
      {videos.map((video) => (
        <div
          ...
          className={`cursor-pointer rounded-2xl overflow-hidden transition-all duration-300
                     hover:shadow-xl hover:scale-[1.02] border-2 bg-white/30 dark:bg-gray-800/40 backdrop-blur-sm
                     ${selectedVideoId === video.id 
                       ? 'border-purple-400 dark:border-cyan-500 shadow-lg shadow-purple-200/50 dark:shadow-cyan-500/30 bg-white/50 dark:bg-gray-800/60' 
                       : 'border-white/40 dark:border-gray-600/40 hover:border-purple-300 dark:hover:border-cyan-600 hover:bg-white/40 dark:hover:bg-gray-800/50'
                     }`}
        >
