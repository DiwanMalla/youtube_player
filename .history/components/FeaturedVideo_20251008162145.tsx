...
export default function FeaturedVideo({
  ...
  return (
    <div className="space-y-6">
      {/* Video Player */}
      <div className="relative aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/40 dark:border-gray-700/40">
        <iframe
      ...
      <div className="space-y-3">
        ...
        <div className="pt-4 border-t border-white/40 dark:border-gray-700/40">
            ...
            {recommendations.map((rec) => (
              <div
                ...
                className="cursor-pointer rounded-2xl overflow-hidden transition-all duration-300
                         hover:shadow-lg hover:scale-[1.02] border border-white/40 dark:border-gray-700/40 
