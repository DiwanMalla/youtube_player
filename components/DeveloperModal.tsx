        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-white/70">diwanportfolio.vercel.app</p>
            </div>
          </a>
          ...
          <a
            ...
            className="flex items-center gap-3 p-3 rounded-xl border border-white/20 bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all group"
          >
            <svg className="w-5 h-5 text-white/80 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
